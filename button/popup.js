...
$(function() {
    ...
    $("#titletext").click(function() {
        var chrome_url = "http://cdn.filteringlist.com/page/banner_title";
    ...
    $("#link_open").click(function() {
        var linkHref = "https://chrome.google.com/webstore/detail/noads-adblocker/alplpnakfeabeiebipdmaenpmbgknjce";
        BG.openTab(linkHref);
        closeAndReloadPopup();
        return;
    });
    ...
    $("#banner_review-link").click(function() {
        window.open("http://cdn.filteringlist.com/page/banner_review");
    });
